...
use eafarris\euikit\Components\Lookup;
...
class euikitServiceProvider extends ServiceProvider {
    ...
    public function boot() : void { //
        ...
        Blade::component('euikit-form-lookup', Lookup::class);
    ...
    public function bootForConsole() : void { //
        ...
        $this->publishes([ __DIR__ . '/../views/components' => resource_path('views/vendor/euikit/components') ], 'euikit.components');
