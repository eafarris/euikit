...
$common_classes = 'block w-full min-h-8 rounded-sm shadow-xs sm:text-sm border leading-tight appearance-none placeholder:italic';
...
<div {{ $attributes->whereDoesntStartWith('wire')->merge(['class' => 'field bg-transparent']) }} id="{{ $field }}">
@unless($nolabel)
