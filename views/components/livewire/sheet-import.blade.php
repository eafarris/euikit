...
@endif
<pre>@php(var_dump($fields))@endphp</pre>
...
@push('modals')
    <x-e::modal name="import">
        ...
        <input class="px-8 text-slate-500
            file:text-slate-500 file:border-transparent file:border file:font-normal file:text-base file:rounded file:py-1 file:px-3 file:h-12 file:flex-none file:justify-center file:items-center file:transition file:hover:scale-110
            file:bg-slate-300 file:text-slate-800 file:hover:bg-slate-500 file:hover:text-white file:disabled:opacity-50"
            type="file" name="importfile" wire:model="importfile" />
