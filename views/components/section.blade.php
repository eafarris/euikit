@props(['header' => '', 'footer' => ''])
<section class="min-w-fit m-12 space-y-6 border-slate-300 bg-gradient-to-br from-slate-100 via-slate-200 via-70% to-80% to-slate-100 dark:border-slate-900 dark:from-slate-600 dark:to-slate-700 border-2 p-6 rounded-lg shadow-2xl"><!-- EUIKit Section component -->
@if($header)
