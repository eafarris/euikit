@props(['header' => '', 'footer' => ''])
<section class="min-w-fit m-12 space-y-6 border-slate-300 bg-slate-100 dark:border-slate-900 dark:bg-slate-600 border-2 p-6 rounded-lg shadow-2xl"><!-- EUIKit Section component -->
@if($header)
