{{--
 ...
 <div {{ $attributes->merge(['class' => 'mt-4 py-3 px-6 rounded-lg border-2 border-slate-300 bg-slate-50/50 text-slate-500 dark:border-slate-700 dark:bg-slate-500 dark:text-slate-300']) }}>
